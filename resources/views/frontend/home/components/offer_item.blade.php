            ...
            <div class="row offer_item_slider wow fadeInUp" data-wow-duration="1s">
                ...
                <div class="col-xl-4">
                    <div class="fp__offer_item_single">
                        <div class="img">
                            <img src="{{ asset($dailyOffer->product->product_image) }}" alt="offer" class="img-fluid w-100">
                        </div>
                        <div class="text">
                            ...
                            <a class="title" href="{{ route('product.show', $dailyOffer->product->slug) }}">{!! $dailyOffer->product->product_name !!}</a>
