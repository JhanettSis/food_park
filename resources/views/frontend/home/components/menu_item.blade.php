...
<div class="col-xl-3 col-sm-6 col-lg-4 {{ $category->slug }} wow fadeInUp" data-wow-duration="1s">
    <div class="fp__menu_item">
        <div class="fp__menu_item_img">
            <img src="{{ $product->product_image }}" alt="menu {{ $product->product_name }}" class="img-fluid w-100">
        ...
        <div class="fp__menu_item_text">
            ...
            <a class="title" href="{{ route('product.show', $product->slug) }}">{{ $product->product_name }}</a>
            <h5 class="price">
