    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.testimonials.index') }}">All Sliders</a></div>
                <div class="breadcrumb-item">Update Testimonial</div>
            </div>
        </div>
                ...
                <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="show_at_home" class="form-control" id="">
                            <option @selected($testimonial->show_at_home === false) value="0">No</option>
                            <option @selected($testimonial->show_at_home === true) value="1">Yes</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="">
                            <option @selected($testimonial->status === true) value="1">Active</option>
                            <option @selected($testimonial->status === false) value="0">Inactive</option>
                        </select>
                    </div>
