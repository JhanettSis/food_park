                ...
                <form action="{{ route('admin.daily-offer.update', $dailyOffer->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="product" class="form-control" id="product_search">
                            <option value="{{ $dailyOffer->product->id }}" selected>{{ $dailyOffer->product->product_name }}</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="">
                            <option @selected($dailyOffer->status === true) value="1">Active</option>
                            <option @selected($dailyOffer->status === false) value="0">Inactive</option>
                        </select>
                    </div>
