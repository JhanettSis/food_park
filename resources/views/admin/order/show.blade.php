                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    {{-- This variable '->product_size' in json_decode($orderItem->product_size)
                                Is coming fron the column in the database order_item table --}}
                                    @foreach ($order->orderItems as $orderItem)
                                        @php
                                            ...
                                            // I add ?? 0; in case the product does not have size.
                                        ...
                                        @endphp
                                        <tr>
                                            {{-- the ++$loop->index syntax is used to increment the index
                                    within a @foreach loop. The @foreach directive is used to iterate
                                    over a collection of items, and the $loop variable is available
                                    within the loop to provide useful information about the loop's
                                    state. --}}
                                            <td>{{ ++$loop->index }}</td>
...
<script>
    $(document).ready(function(){
        $('#print_btn').on('click', function() {
            ...
            let printWindow = window.open('', '', 'width=1600,height=1200');
            printWindow.document.open();

            // Write the HTML structure to the print window
            printWindow.document.write('<html>');
            // Output the CSS link with Blade syntax inside the document.write
