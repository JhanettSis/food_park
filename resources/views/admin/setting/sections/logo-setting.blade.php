<div class="tab-pane fade show" id="logoSetting" role="tabpanel" aria-labelledby="logo-tab4">
    <div class="card">
        <div class="card-body border">
            <form action="{{ route('admin.logo_setting.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
