...
class TestimonialController extends Controller
{
    ...
    {
        $imagePath = $this->uploadImage($request, 'image', '/testimonialImages');
    ...
    public function update(TestimonialUpdateRequest $request, string $id)
    {
        ...
        if ($request->hasFile('image')) {
            if ($testimonial->image != '/uploads/imageDefault.jpg') {
                $imagePath = $this->uploadImage($request, 'image', '/testimonialImages', $testimonial->image);
            } else {
                $imagePath = $this->uploadImage($request, 'image', '/testimonialImages');
            }
