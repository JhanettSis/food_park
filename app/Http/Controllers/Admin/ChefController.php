...
class ChefController extends Controller
{
    ...
    {
        $imagePath = $this->uploadImage($request, 'image', '/chefImages');
    ...
    public function update(ChefUpdateRequest $request, string $id) : RedirectResponse
    {
        ...
        if ($request->hasFile('image')) {
            if ($chef->image != '/uploads/imageDefault.jpg') {
                $imagePath = $this->uploadImage($request, 'image', '/chefImages', $chef->image);
            } else {
                $imagePath = $this->uploadImage($request, 'image', '/chefImages');
            }
